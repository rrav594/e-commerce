...
function CheckOut() {
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div className="m-10 grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
          ...
          <form className="bg-white p-10">
            ...
            <div>
              ...
              <div className="mt-6 flex items-center justify-end gap-x-6">
                ...
                <button
                  type="submit"
                  className="rounded-md bg-indigo-600 px-3 py-2 text-s font-semibold text-white shadow-md"
                >
                  Add Address
                </button>
              </div>
                      ...
                      <div className="ml-4 flex flex-1 flex-col">
                        ...
                        <div className="flex flex-1 items-end justify-between text-sm">
                          <p className="text-gray-500">
                            ...
                            <select
                              className="border-none hover:bg-gray-200 ml-5"
                              id="quantity"
                            >
